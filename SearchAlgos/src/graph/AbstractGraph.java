...
/**
 * <p>AbstractGraph.java is an abstract class that implements the Graph Interface.
 *  Breadth First Search and Depth First Search are implemented in AbstractGraph.</p>
 *
...
public abstract class AbstractGraph<V> implements Graph<V> {
	...
	/**
	 * DFS tree starting from vertex v algorithm dfs(vertex v) { visit v; for
	 * each neighbor w of v if (w has not been visited) { dfs(w); } }
	 * */
	...
	/**
	 * BFS search algorithm bfs(vertex v) create an empty queue for storing
	 * vertices to be visited; add v into the queue; mark v visited;
	 * 
	 * while the queue !empty dequeue a vertex, say u, from the queue add u into
	 * a list of traversed vertices for each neighbour w of u if w has not been
	 * visited { add w into the queue; mark w visited; } } }
	 * 
	 * */
